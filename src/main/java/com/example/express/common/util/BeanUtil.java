...
public abstract class BeanUtil {
    ...
    public static void copySpecificProperties(Object source, Object target, String... properties) {
        Set<String> propertiesSet = Collections.unmodifiableSet(new HashSet<>(Arrays.asList(properties)));
        BeanWrapper srcWrapper = new BeanWrapperImpl(source);
        BeanWrapper trgWrapper = new BeanWrapperImpl(target);

        for (String property : propertiesSet) {
            Object value = srcWrapper.getPropertyValue(property);
            trgWrapper.setPropertyValue(property, value);
        }
    }
